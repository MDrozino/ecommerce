        ...
        do {
            ...
            switch (option) {
                ...
                case 5:
                    ...
                    PaymentType tipoDePagamento = switch (opcaoPagamento) {
                    ...
                    PaymentMethodFactory pagamentoFactory = new PaymentMethodFactory();
                    PaymentMethod metodo = pagamentoFactory.create(tipoDePagamento);
                    metodo.pay(total);
