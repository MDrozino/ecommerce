...
public class Main {
    public static void main(String[] args) {
        ...
        SaleRepository saleRepository = new SaleRepository(conn);
        SaleProductRepository saleProductRepository = new SaleProductRepository(conn);
        ...
        do {
            ...
            switch (option) {
                ...
                case 5:
                    ...
                    System.out.println("\nResumo da venda:");
                    System.out.println("Cliente: " + user.toString());
                    for (Product p : produtos) {
